package org.flemit.bytecode
{
	...
	{
		public static const instance:Instructions = new Instructions();
		...
		public const Add : uint =  0xa0;
		public const AddInteger : uint =  0xc5;
		public const AsType : uint =  0x86; // u30 (type_index)
		public const AsTypeLate : uint =  0x87;
		public const BitAnd : uint =  0xa8;
		public const BitNot : uint =  0x97;
		public const BitOr : uint =  0xa9;
		public const BitXor : uint =  0xaa;
		public const Call : uint =  0x41; // u30 (arg_count)
		public const CallMethod : uint =  0x43; // u30 (index); u30 (arg_count)
		public const CallProperty : uint =  0x46; // u30 (index); u30 (arg_count)
		public const CallPropLex : uint =  0x4c; // u30 (index); u30 (arg_count)
		public const CallPropVoid : uint =  0x4f; // u30 (index); u30 (arg_count)
		public const CallStatic : uint =  0x44; // u30 (index); u30 (arg_count)
		public const CallSuper : uint =  0x45; // u30 (index); u30 (arg_count)
		public const CallSuperVoid : uint =  0x4e; // u30 (index); u30 (arg_count)
		public const CheckFilter : uint =  0x78;
		public const Coerce : uint =  0x80; // u30 (index)
		public const CoerceAny : uint =  0x82; // 
		public const CoerceString : uint =  0x85;
		public const Construct : uint =  0x42; // u30 (arg_count)
		public const ConstructProp : uint =  0x4a; // u30 (index); u30 (arg_count)
		public const ConstructSuper : uint =  0x49; // u30 (arg_count)
		public const ConvertBoolean : uint =  0x76;
		public const ConvertInteer : uint =  0x73;
		public const ConvertDouble : uint =  0x75;
		public const ConvertObject : uint =  0x77;
		public const ConvertUInteger : uint =  0x74;
		public const ConvertString : uint =  0x70;
		public const Debug : uint =  0xef; // u8 (DI_LOCAL : uint =  1); u30 (string index); u8 (register); u30 (unused)
		public const DebugFile : uint =  0xf1; // u8 (string index)
		public const DebugLine : uint =  0xf0; // u8 (line num)
		public const DecrementLocal : uint =  0x94; // u8 (register index)
		public const DecrementLocalInteger : uint =  0xc3; // u8 (register index)
		public const Decrement : uint =  0x93; 
		public const DecrementInteger : uint =  0xc1;
		public const DeleteProperty : uint =  0x6a; // u8 (multiname index)
		public const Divide : uint =  0xa3;
		public const Duplicate : uint =  0x2a;
		public const DefaultXMLNamespace : uint =  0x06; // u30 (string index)
		public const DefaultXMLNamespaceLate : uint =  0x07;
		public const Equals : uint =  0xab;
		public const EscapeXmlAttribute : uint =  0x72;
		public const EscapeXmlElement : uint =  0x71;
		public const FindProperty : uint =  0x5e; // u30 (multiname index)
		public const FindPropertyStrict : uint =  0x5d; // u30 (multiname index)
		public const GetDescendants : uint =  0x59; // u30 (multiname index)
		public const GetGlobalScope : uint =  0x64;
		public const GetGlobalSlot : uint =  0x6e; // u30 (slot index)
		public const GetLex : uint =  0x60; // u30 (multiname index)
		public const GetLocal : uint =  0x62; // u30 (index)
		public const GetLocal_0 : uint =  0xd0;
		public const GetLocal_1 : uint =  0xd1;
		public const GetLocal_2 : uint =  0xd2;
		public const GetLocal_3 : uint =  0xd3;
		public const GetProperty : uint =  0x66; // u8 (multiname index)
		public const GetScopeObject : uint =  0x65; // u8 (index)
		public const GetSlot : uint =  0x6c; // u8 (index)
		public const GetSuper : uint =  0x04; // u8 (multiname index)
		public const GreaterEquals : uint =  0xaf;
		public const GreaterThan : uint =  0xaf; // ??
		public const HasNext : uint =  0x1f;
		public const HasNext2 : uint =  0x32; // u8 (object_reg); u8 (index_reg)
		public const IfEquals : uint =  0x13; // u8 (offset)
		public const IfFalse : uint =  0x12; // u8 (offset)
		public const IfGreaterThanOrEquals : uint =  0x18; // u8 (offset)
		public const IfGreaterThan : uint =  0x17; // u8 (offset)
		public const IfLessThanOrEquals : uint =  0x16; // u8 (offset)
		public const IfLessThan : uint =  0x15; // u8 (offset)
		public const IfNotGreaterThanOrEquals : uint =  0x0f; // u8 (offset)
		public const IfNotGreaterThan : uint =  0x0e; // u8 (offset)
		public const IfNotLessThanOrEquals : uint =  0x0d; // u8 (offset)
		public const IfNotLessThan : uint =  0x0c; // u8 (offset)
		public const IfNotEquals : uint =  0x14; // u8 (offset)
		public const IfStrictEquals : uint =  0x19; // u8 (offset)
		public const IfStrictNotEquals : uint =  0x1a; // u8 (offset)
		public const IfTrue : uint =  0x11; // u8 (offset)
		public const In : uint =  0xb4;
		public const IncrementLocal : uint =  0x92; // u30 (local register)
		public const IncrementLocalInteger : uint =  0xc2; // u30 (local register)
		public const Increment : uint =  0x91;
		public const IncrementInteger : uint =  0xc0;
		public const InitProperty : uint =  0x68; // u30 (multiname index)
		public const InstanceOf : uint =  0xb1;
		public const IsType : uint =  0xb2; // u30 (multiname index)
		public const IsTypeLate : uint =  0xb3;
		public const Jump : uint =  0x10; // s24 (offset)
		public const Kill : uint =  0x05; // u30 (local register)
		public const Label : uint =  0x09;
		public const LessThanOrEquals : uint =  0xae;
		public const LessThan : uint =  0xad;
		public const LookUpSwitch : uint =  0x1b; // s24 (default_offset); u30 (case_count); s24[case_count] (case_offset)
		public const LeftShift : uint =  0xa5;
		public const Modulo : uint =  0xa4;
		public const Multiply : uint =  0xa2;
		public const MultiplyInteger : uint =  0xc7;
		public const Negate : uint =  0x90;
		public const NegateInteger : uint =  0xc4;
		public const NewActivation : uint =  0x57;
		public const NewArray : uint =  0x56; // u30 (arg_count)
		public const NewCatch : uint =  0x5a; // u30 (exception_info index)
		public const NewClass : uint =  0x58; // u30 (class info)
		public const NewFunction : uint =  0x40; // u30 (arg_count)
		public const NewObject : uint =  0x55;
		public const NextName : uint =  0x1e;
		public const NextValue : uint =  0x23;
		public const Nop : uint =  0x02;
		public const Not : uint =  0x96;
		public const Pop : uint =  0x29;
		public const PopScope : uint =  0x1d;
		public const PushByte : uint =  0x24; // u8 (byte value)
		public const PushDouble : uint =  0x2f; // u30 (double index)
		public const PushFalse : uint =  0x27;
		public const PushInt : uint =  0x2d; // u30 (int index)
		public const PushNamespace : uint =  0x31; // u30 (namespace index)
		public const PushNaN : uint =  0x28;
		public const PushScope : uint =  0x30;
		public const PushNull : uint =  0x20;
		public const PushShort : uint =  0x25; // u30 (short value)
		public const PushString : uint =  0x2c; // u30 (string value)
		public const PushTrue : uint =  0x26;
		public const PushUInt : uint =  0x2e; // u30 (uint value)
		public const PushUndefined : uint =  0x21;
		public const PushWith : uint =  0x1c;
		public const ReturnValue : uint =  0x48;
		public const ReturnVoid : uint =  0x47;
		public const RightShift : uint =  0xa6;
		public const SetLocal : uint =  0x63; // u30 (index)
		public const SetLocal_0 : uint =  0xd4;
		public const SetLocal_1 : uint =  0xd5;
		public const SetLocal_2 : uint =  0xd6;
		public const SetLocal_3 : uint =  0xd7;
		public const SetGlobalSlot : uint =  0x6f; // u30 (slot index)
		public const SetProperty : uint =  0x61; // u30 (multiname)
		public const SetSlot : uint =  0x6d; // u30 (index)
		public const SetSuper : uint =  0x05; // u30 (multname)
		public const StrictEquals : uint =  0xac;
		public const Subtract : uint =  0xa1;
		public const SubsctractInteger : uint =  0xc6;
		public const Swap : uint =  0x2b;
		public const Throw : uint =  0x03;
		public const TypeOf : uint =  0x95;
		public const UnsignedRightShift : uint =  0xa7;
	}
}